  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16">
          ...
          <div className="container mx-auto px-4">
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-600 max-w-xl mx-auto">
                Our menu features traditional Irish favorites alongside
                international dishes prepared with locally sourced ingredients.
              </p>
            </div>
            ...
            <div className="text-center mt-12 bg-white p-6 rounded-lg shadow-md mx-auto max-w-2xl">
              ...
              <p className="text-gray-600 mb-6">
                Please inform our staff about any allergies or dietary
                requirements. We're happy to accommodate your needs where
                possible.
              </p>
              <Button
                asChild
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {category.items.map((item) => (
                    ...
                    >
                      <div className="p-6 w-full">
                        <div className="flex justify-between items-start">
                          <h4 className="text-xl font-bold font-serif text-irish-brown">
                            {item.name}
                          </h4>
                          <span className="text-xl font-medium text-irish-red">
                            {item.price}
        ...
        {/* Placeholder for Breakfast Menu */}
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-serif font-bold mb-8 text-irish-red">
              Breakfast Menu
