    ...
    <footer className="bg-irish-red pt-12 pb-8 text-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-serif font-bold text-irish-gold mb-4">
              D'Arcy McGee's
            </h3>
            <p className="mb-4">
              Experience the warmth and hospitality of Ireland in every visit.
            </p>
          ...
          <div>
            <h4 className="text-xl font-serif font-semibold text-irish-gold mb-4">
              Hours
            </h4>
          ...
          <div>
            ...
            <p className="mb-2">Wellington Ln, Templeogue</p>
            <p className="mb-2">Dublin 6W, Dublin</p>
        ...
        <div className="border-t border-irish-gold/20 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link
                to="/about"
                className="text-sm text-gray-300 hover:text-irish-gold"
              >
                About Us
              </Link>
              <Link
