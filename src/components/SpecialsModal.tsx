...
const SpecialsModal: React.FC<SpecialsModalProps> = ({ open, onClose }) => {
  ...
  // Strict selection: only items from the category named "Week Specials" (case-insensitive)
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl shadow-2xl p-6 max-w-3xl w-full mx-4"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-start justify-between mb-4">
          <h3 className="text-xl font-semibold text-irish-red">
            Chef Specials Today
          </h3>
          <Button variant="ghost" onClick={onClose} className="text-irish-red">
            ×
          </Button>
        </div>
        ...
        {itemsToShow.length === 0 ? (
          <p className="text-gray-600">
            No specials available right now. Check back later.
          </p>
        ) : (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-irish-red font-semibold">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        {item.allergens.map((aid) => {
                          ...
                          return Icon ? (
                            ...
                            <span key={aid} className="text-xs text-irish-red">
                              {aid}
                            </span>
                          );
                        })}
